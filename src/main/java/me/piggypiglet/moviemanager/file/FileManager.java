...
public final class FileManager {
    ...
    public FileConfiguration load(String name, String internalPath, String externalPath) throws Exception {
        ...
        if (!file.exists()) {
            ...
            if (file.createNewFile() && FileUtils.exportResource(MovieManagerBootstrap.class.getResourceAsStream(internalPath), externalPath)) {
    ...
    private FileConfiguration load(String name, String path) throws Exception {
        InputStream stream = MovieManagerBootstrap.class.getResourceAsStream(path);
